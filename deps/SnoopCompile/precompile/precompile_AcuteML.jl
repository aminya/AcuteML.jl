function _precompile_()
    ...
    precompile(Tuple{typeof(AcuteML.arg_const),Bool,Expr,Symbol,String,Type{T} where T,Missing,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_const),Bool,Symbol,Symbol,String,Type{T} where T,Missing,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_const),Bool,Symbol,Symbol,String,Type{T} where T,Symbol,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_const),Bool,Type{T} where T,Symbol,String,Type{T} where T,Missing,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_ext),Bool,Expr,Symbol,String,Type{T} where T,Missing,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_ext),Bool,Symbol,Symbol,String,Type{T} where T,Missing,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_ext),Bool,Symbol,Symbol,String,Type{T} where T,Symbol,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_ext),Bool,Type{T} where T,Symbol,String,Type{T} where T,Missing,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_mutability),Bool,Expr,Symbol,String,Type{T} where T,Missing,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_mutability),Bool,Symbol,Symbol,String,Type{T} where T,Missing,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_mutability),Bool,Symbol,Symbol,String,Type{T} where T,Symbol,QuoteNode,Expr})
    precompile(Tuple{typeof(AcuteML.arg_mutability),Bool,Type{T} where T,Symbol,String,Type{T} where T,Missing,QuoteNode,Expr})
