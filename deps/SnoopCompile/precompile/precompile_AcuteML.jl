function _precompile_()
    ...
    precompile(Tuple{typeof(appendchild!),Document,String,Nothing,Type{AbsAttribute}})
    precompile(Tuple{typeof(appendchild!),Node,String,Array{Any,1},Type{AbsNormal}})
    precompile(Tuple{typeof(appendchild!),Node,String,Array{Float64,1},Type{AbsNormal}})
    precompile(Tuple{typeof(appendchild!),Node,String,Array{Int64,1},Type{AbsNormal}})
    precompile(Tuple{typeof(appendchild!),Node,String,Array{String,1},Type{AbsNormal}})
    precompile(Tuple{typeof(appendchild!),Node,String,Float64,Type{AbsNormal}})
    precompile(Tuple{typeof(appendchild!),Node,String,Int64,Type{AbsNormal}})
    precompile(Tuple{typeof(appendchild!),Node,String,Nothing,Type{AbsAttribute}})
    precompile(Tuple{typeof(appendchild!),Node,String,Nothing,Type{AbsNormal}})
    precompile(Tuple{typeof(appendchild!),Node,String,String,Type{AbsAttribute}})
    precompile(Tuple{typeof(appendchild!),Node,String,String,Type{AbsNormal}})
